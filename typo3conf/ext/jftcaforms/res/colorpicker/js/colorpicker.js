var colorPicker=Class.create({
	initialize:function(){
		...
		this.options.origColor = this.HexToHSB(this.options.origColor ? this.options.origColor : this.options.color);
	...
	downSelector:function(ev){
		var tmpPos = ev.element().cumulativeOffset();
		var tmpScr = ev.element().cumulativeScrollOffset();
		tmpPos.left -= tmpScr.left;
		tmpPos.top  -= tmpScr.top;
		this.current = {
			pos: tmpPos,
			preview: this.options.livePreview
		};
